 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg*3.1416/180 + min*3.1416/180/60 + sec*3.1416/180/3600
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val y: Double = (percent*1.0) / 100
    val x1: Double = initial + initial * y
    val x2: Double = x1 + x1 * y
    val x3: Double = x2 + x2 * y
    return x3
}
